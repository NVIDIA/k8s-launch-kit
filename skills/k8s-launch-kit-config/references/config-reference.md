...
docaDriver:
  ...
  # Literal environment variables forwarded through the generated
  # NicClusterPolicy or NicNodePolicy. A custom value overrides every value
  # generated by another docaDriver field with the same name. Duplicate custom
  # names use the last value. Incorrect driver options can disrupt networking.
  # env:
