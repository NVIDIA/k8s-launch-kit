...
Available Commands:
  chat        Interactive AI-assisted networking session
...
Flags:
  ...
  -h, --help                                help for l8k
      ...
      --llm-throttle                        Enable rate limit throttling for LLM API calls (use when hitting token-per-minute limits)
  ...
  -q, --quiet                               Suppress informational output (errors still shown)
      ...
      --sosreport-path string               Path to pre-collected sosreport directory for troubleshooting analysis (implies --llm-interactive)
